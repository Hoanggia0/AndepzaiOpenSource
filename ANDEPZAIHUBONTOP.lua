--// Crack By Andepzai Hub - https://discord.com/invite/vCZ5k6dG
...
local c = require(b.PlayerScripts.CombatFramework.Particle)
local f = require(game:GetService("ReplicatedStorage").CombatFramework.RigLib)
spawn(function()
    while task.wait() do
        if _G.FastAttack then
            pcall(function()
                if not shared.orl then
                    shared.orl = f.wrapAttackAnimationAsync
                end
...
function UpdateBfEsp()for b,b in pairs(game:GetService("Workspace"):GetChildren())do pcall(function()
